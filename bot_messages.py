start_command_response = "Здравствуйте 👋🏼! Я бот-оффициант. Напишите мне номер своего столика с помощью функции /add ." \
"\n" \
"\n" \
...
"\n" \
"\n" \
"1. /add <Новое задание> - Добавить заказ." \
"\n" \
"2. /delete <Номер задания> - удалить блюдо из списка заказов." \
"\n" \
"3. /showmenu - Показать весь заказ." \
"\n" \
"4. /clear - Очистить весь ваш список." \
"\n" \
"5. /feedback - Отправить предложение/жалобу администрации заведения" \
"\n" \
"6. /help - Список всех доступных команд."
...
add_task_write_task = "Хорошо, введите номер вашего столика и нажмите /add 🗒:" \
"\n" \
"\n" \
"/add - добавить блюдо в список заказов"\
