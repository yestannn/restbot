start_command_response = "Здравствуйте👋🏼! Я бот-оффициант. Напишите мне номер своего столика с помощью функции /add и сделайте заказ." \
"\n" \
"\n" \
...
"\n" \
"5. /feedback - Отправить предложение/жалобу разработчику" \
"\n" \
...
add_task_write_task = "Хорошо, введите блюдо которое хотите добавить в список 🗒:" \
"\n" \
"\n" \
