...
"\n" \
"\n" \
"1. /add - Добавить блюде в вашу корзину." \
"\n" \
"2. /delete - удалить блюдо из корзины." \
"\n" \
"3. /showorder - Показать все что в вашей корзине." \
"\n" \
"4. /clear - Очистить корзину." \
"\n" \
"5. /order - Отправить меню администратору." \
"\n" \
"6. /feedback - Отправить предложение/жалобу администрации заведения" \
"\n" \
